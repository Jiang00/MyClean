...
import com.eos.manager.AppLockSetPattern;
    ...
    public static void showResetPasswordDialog(final Context c) {
        ...
        resetPattern.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(c, AppLockSetPattern.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("set", AppLockSetPattern.SET_GRAPH_PASSWD);
                c.startActivity(intent);
        ...
        resetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(c, AppLockSetPattern.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("set", AppLockSetPattern.SET_NORMAL_PASSWD);
                c.startActivity(intent);
