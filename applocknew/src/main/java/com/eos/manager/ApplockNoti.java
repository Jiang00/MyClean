 ...
 * @author IceStar
 */
public class ApplockNoti extends Service {
    ...
    public static Notification liteA(Context paramContext) {
        try  {
    ...
    public static void liteA(Service service) {
        if(service == null)return;
        try {
            Notification localNotification = liteA(service.getApplicationContext());
