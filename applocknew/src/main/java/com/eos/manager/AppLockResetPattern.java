 ...
 */
public class AppLockResetPattern extends SecurityAbsActivity {
                    ...
                    public void run(AccountManagerFuture<Bundle> future) {
                        try {
                            ...
                            if (future.getResult().getBoolean(AccountManager.KEY_BOOLEAN_RESULT)) {
                                context.startActivity(new Intent(context, AppLockSetPattern.class).putExtra("set", AppLockSetPattern.SET_GRAPH_PASSWD));
                                context.finish();
                            } else {
                                MessageBox.Data data = new MessageBox.Data();
