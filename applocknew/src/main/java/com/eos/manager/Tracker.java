...
public class Tracker {
    ...
    public static final String CATE_ACTION_UNLOCK_SUSSFUL = "解锁应用成功";

    public static final String CATE_ACTION_UNLOCK_PAGE = "解锁界面";
    public static final String CATE_ACTION_UNLOCK_PAGE_OPEN = "解锁界面弹出次数";
