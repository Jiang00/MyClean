...
import com.eos.manager.lib.datatype.SInt;
...
//        }
    ...
    public static void setMainFirstFull(boolean yes) {
        App.getSharedPreferences().edit().putBoolean("show_main_first_full_", yes).apply();
    }

    public static boolean getMainFirstFull() {
        return App.getSharedPreferences().getBoolean("show_main_first_full_", true);
    }


    public static void setMainFirstFullCountDown(int min) {
        App.getSharedPreferences().edit().putInt("show_main_first_full__won", min).apply();
    }

    public static int getMainFirstFullCountDown() {
        return App.getSharedPreferences().getInt("show_main_first_full__won", 0);
    }


    public static void setPasswordLockOk(boolean yes) {
        App.getSharedPreferences().edit().putBoolean("set_password_ok_lock_", yes).apply();
    }

    public static boolean getPasswordLockOk() {
        return App.getSharedPreferences().getBoolean("set_password_ok_lock_", false);
    }
