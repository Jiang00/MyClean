...
public class SlideMenuNew extends FrameLayout {
    ...
    public SlideMenuNew(Context context) {
        this(context, null);
    }

    public SlideMenuNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideMenuNew(Context context, AttributeSet attrs, int defStyle) {
