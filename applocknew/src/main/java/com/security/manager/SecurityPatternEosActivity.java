 ...
 */
public class SecurityPatternEosActivity extends SecuritySetPattern {
    ...
    public void firstTimeLaunch() {
        ...
        lv.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    convertView = LayoutInflater.from(SecurityPatternEosActivity.this).inflate(R.layout.security_locked_apps, parent, false);
                ...
                for (int i = 0; i < pkgs.size(); ++i) {
                    ...
                    if ((pkg.activityInfo.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM) != 0) {
                        ...
                        if (labels.size() == 10 || i == pkgs.size() - 1) {
                            ...
                            labels.clear();
                            apps.clear();
                            SecurityPatternEosActivity.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
...
//            }.start();
            ...
            this.finish();
            Intent intent = new Intent(SecurityPatternEosActivity.this,SecurityAppLock.class);
