        ...
        switch (act) {
            ...
            case Intent.ACTION_PACKAGE_ADDED:{
                ...
                if (sp.getBoolean(SecurityMyPref.LOCK_NEW, SecurityMyPref.LOCK_DEFAULT)){
                    context.startService(new Intent(context, SecurityEosService.class).putExtra(SecurityEosService.WORK_EXTRA_KEY, SecurityEosService.WORK_LOCK_NEW).putExtra("pkg", pkg));
                }
            }
                break;
            case Intent.ACTION_USER_PRESENT:
                context.startService(new Intent(context, SecurityEosService.class).putExtra("on", true));
                break;
