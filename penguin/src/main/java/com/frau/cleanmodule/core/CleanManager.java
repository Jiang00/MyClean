package com.frau.cleanmodule.core;
...
import com.frau.cleanmodule.callback.AppCacheCallBack;
import com.frau.cleanmodule.callback.AppRamCallBack;
import com.frau.cleanmodule.callback.FileInfoCallBack;
import com.frau.cleanmodule.callback.SystemCacheCallBack;
import com.frau.cleanmodule.callback.UninstallResidualCallback;
import com.frau.cleanmodule.db.CleanDBHelper;
import com.frau.cleanmodule.entity.JunkInfo;
import com.frau.cleanmodule.entity.Sizesort;
import com.frau.cleanmodule.filemanager.FileCategoryHelper;
import com.frau.cleanmodule.filemanager.FileSortHelper;
import com.frau.cleanmodule.util.MemoryManager;
    ...
    public void loadApkFile(FileInfoCallBack fileInfoCallBack) {
        ...
        if (cursor != null && cursor.getCount() != 0) {
            ...
            do {
                ...
                String name = com.frau.cleanmodule.filemanager.Util.getNameFromFilepath(path);
