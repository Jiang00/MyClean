package com.vater.module.charge.saver.service;
...
import com.vater.module.charge.saver.BatteryChargeActivity;
...
import com.vater.module.charge.saver.Util.WidgetContainer;
...
public class BatteryService extends Service {
    ...
    private void showChargeView() {
        ...
        if ((Boolean) Utils.readData(this, Constants.IS_ACTIVITY, true)) {
            ...
            intent.setClass(this, BatteryChargeActivity.class);
