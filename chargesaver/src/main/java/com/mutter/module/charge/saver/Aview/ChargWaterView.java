...
import com.mutter.module.charge.saver.R;
...
public class ChargWaterView extends View {
    ...
    private void initPaints() {
        ...
        textSize_b = getResources().getDimensionPixelSize(R.dimen.d100);
...
//        firstPaint.setStrokeJoin(Paint.Join.ROUND);
    ...
    public void draw(Canvas canvas) {
        ...
        firstPaint.setColor(Color.parseColor("#929499"));
        firstPaint.setTextSize(textSize_b);
        ...
        firstPaint.setColor(Color.parseColor("#ffffff"));
    ...
    private Path firstPath() {
        ...
        firstPath.lineTo(width, y);
        firstPath.lineTo(0, y);
        firstPath.close();
        return firstPath;
    }
