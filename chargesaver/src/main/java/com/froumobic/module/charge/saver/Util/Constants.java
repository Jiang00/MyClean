...
public class Constants {
    public static final String MODULE_FILL_NAME = "froumobi_battery_charge_saver";
    ...
    public static final String ACTION_CHARGE_SAVER_SWITCH_STATE = "com.froumobi.module.charge.saver.switch";
