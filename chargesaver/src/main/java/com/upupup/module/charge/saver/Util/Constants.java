package com.upupup.module.charge.saver.Util;
...
public class Constants {
    public static final String MODULE_FILL_NAME = "mutter_battery_charge_saver";
    ...
    public static final String ACTION_CHARGE_SAVER_SWITCH_STATE = "com.mutter.module.charge.saver.switch";
