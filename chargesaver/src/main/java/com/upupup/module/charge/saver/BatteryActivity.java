...
//        super.onUserLeaveHint();
        this.finish();
        overridePendingTransition(com.upupup.module.charge.saver.R.anim.charge_exit, com.upupup.module.charge.saver.R.anim.charge_exit);
    }
...
//        super.onBackPressed();
    ...
    private void doBar() {
        try {
            batteryView = (BatteryView) LayoutInflater.from(this).inflate(com.upupup.module.charge.saver.R.layout.charge_saver, null);
            setContentView(batteryView);
            batteryView.setUnlockListener(new BatteryView.UnlockListener() {
                @Override
                public void onUnlock() {
                    overridePendingTransition(android.R.anim.fade_in, com.upupup.module.charge.saver.R.anim.charge_exit);
                    finish();
                }
            });
            Log.e("battery", "bar===");
