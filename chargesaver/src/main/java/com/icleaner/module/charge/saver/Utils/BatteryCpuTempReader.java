package com.icleaner.module.charge.saver.Utils;
...
public class BatteryCpuTempReader {
	public static final String TAG = BatteryCpuTempReader.class.getSimpleName();
