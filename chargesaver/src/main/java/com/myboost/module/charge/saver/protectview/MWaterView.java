 ...
 */
public class MWaterView extends View {
    public int width;
    public int height;
    ...
    public MWaterView(Context context) {
        this(context, null);
    }

    public MWaterView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MWaterView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        firstPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_OVER));
        ...
        beijingPaint.setColor(ContextCompat.getColor(context, R.color.white_15));

        // 文字
        textPaint = new Paint();
        textSize = context.getResources().getDimensionPixelSize(R.dimen.s14);
    ...
    public void draw(Canvas canvas) {
        ...
        firstPaint.setColor(Color.parseColor("#4c9df5"));
        canvas.drawCircle(width / 2, height / 2, width / 2, firstPaint);
        firstPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_ATOP));
        firstPaint.setColor(Color.parseColor("#30ffffff"));
