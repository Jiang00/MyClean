...
import com.eifmobi.clean.junk.myAdapter.SideAdapter;
import com.eifmobi.clean.junk.myview.BubbleMainLayout;
import com.eifmobi.clean.junk.myview.CatShuView;
import com.eifmobi.clean.junk.myview.LoadingTime;
import com.eifmobi.clean.junk.myview.RoundRam;
import com.eifmobi.clean.junk.myview.RoundSd;
import com.eifmobi.clean.junk.presenter.MainPresenter;
...
import com.eifmobi.clean.junk.view.MainView;
...
public class MainActivity extends BaseActivity implements MainView {
    ...
    private String TAG_START_FULL = "_start_native";
    private String TAG_EXIT_FULL = "_exit_native";
    ...
    private String EXIT_FULL = "exit_full";//
            ...
            switch (v.getId()) {
                ...
                case R.id.ad_delete:
                    ...
                    if (PreData.getDB(MainActivity.this, Constant.FULL_START, 0) == 1) {
                        ...
                        load_rotate = ObjectAnimator.ofFloat(load_1, View.ROTATION, 0, -360);
                        load_rotate.setRepeatCount(1);
                        load_rotate.setDuration(2300);
                        load_rotate.start();
