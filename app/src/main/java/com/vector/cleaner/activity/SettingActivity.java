...
public class SettingActivity extends BaseActivity {
    ...
    private String TAG_SETTING = "vector_setting";
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.setting_file:
                    ...
                    Intent intentF = new Intent(SettingActivity.this, FilesActivity.class);
                ...
                case R.id.setting_hui:
                    ...
                    Intent intenth = new Intent(SettingActivity.this, HuishouActivity.class);
                ...
                case R.id.setting_notifi:
                    ...
                    if (!Util.isNotificationListenEnabled(SettingActivity.this) || !PreData.getDB(SettingActivity.this, Constant.KEY_NOTIFI, true)) {
                        Intent intent6 = new Intent(SettingActivity.this, NotifiYindaoActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 100) {
            if (Util.isNotificationListenEnabled(this)) {
                ...
                Intent intent = new Intent(this, NotifiYindaoActivity.class);
                startActivity(intent);
            }
        }
    }
