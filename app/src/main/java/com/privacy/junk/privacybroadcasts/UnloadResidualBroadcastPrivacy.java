package com.privacy.junk.privacybroadcasts;
...
import com.privacy.junk.activityprivacy.PrivacyUnloadingResidualActivity;
...
public class UnloadResidualBroadcastPrivacy extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Intent.ACTION_PACKAGE_REMOVED)) {
            ...
            context.startActivity(new Intent(context, PrivacyUnloadingResidualActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK).putExtra("packageName", packageName));
        }
