...
//        canvas.restore();
    ...
    private PrivacyYuanHuView.DrawYuanHuListener scanEndListener;

    public void setScanCallBack(PrivacyYuanHuView.DrawYuanHuListener listener) {
