...
public class PrivacyDrawHookView extends View {
    //线1的x轴
    ...
    private int move_distance = MyUtils.dp2px(2);

    DrawHookListener drawHookListener;
    private Paint paint;

    public PrivacyDrawHookView(Context context) {
        this(context, null);

    }

    public PrivacyDrawHookView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PrivacyDrawHookView(Context context, AttributeSet attrs, int defStyle) {
...
//        paint.setColor(getResources().getColor(R.color.white_40));
        //设置圆弧的宽度
        paint.setStrokeWidth(MyUtils.dp2px(5));
        //设置圆弧为空心
...
//        paint.setStrokeCap(Paint.Cap.ROUND);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //定义的圆弧的形状和大小的界限
//        RectF rectF = new RectF(0 + MyUtils.dp2px(5), 0 + MyUtils.dp2px(5), size - MyUtils.dp2px(5), size - MyUtils.dp2px(5));
...
//        canvas.drawArc(rectF, 235, -360 * progress / 100, false, paint);
        ...
        if (line1_x < radius / 3) {
            ...
            canvas.drawLine(center1, center, center1 + line1_x, center + line1_y, paint);
            //画第二根线
            canvas.drawLine(center1 + line1_x - MyUtils.dp2px(3), center + line1_y, center1 + line2_x, center + line2_y, paint);
        } else {
