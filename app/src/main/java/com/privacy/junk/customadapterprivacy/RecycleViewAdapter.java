...
import com.privacy.junk.privacycustomview.PrivacyGridLayoutManager;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.MyViewHolder> {
    private PictActivityPrivacy pictureActivity;
    ...
    public RecycleViewAdapter(PictActivityPrivacy pictureActivity, ArrayList<ArrayList<ImageInfo>> totalSimilarImage, ImageHelper imageHelper, Handler handler) {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.HomeViewHolder> {
        ...
        public void onBindViewHolder(final HomeAdapter.HomeViewHolder holder, final int position) {
            ...
            if (imgTime1 != imgTime2) {
                holder.picture_time2.setVisibility(View.VISIBLE);
                if (imgTime1 == null) {
                    imgTime1 = list.get(position).tag_datetime;
                }
                imgTime2 = imgTime1;
            ...
            if (cachebitmap != null) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // final Bitmap bitmap = imageHelper.pathWithScaledBitmap(pictureActivity, info.path, MyUtils.dp2px(112), MyUtils.dp2px(112));
                        if (bitmap != null) {
