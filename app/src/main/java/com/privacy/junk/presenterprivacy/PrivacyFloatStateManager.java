...
import com.privacy.junk.activityprivacy.SuspensionBallActivityPrivacy;
import com.privacy.junk.privacycustomview.PrivacyFloatStateView;
    ...
    private PrivacyFloatStateManager(final Context context) {
        ...
        circleView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, SuspensionBallActivityPrivacy.class);
                //用Bundle携带数据
