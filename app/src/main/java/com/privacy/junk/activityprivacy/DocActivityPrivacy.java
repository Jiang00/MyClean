...
public class DocActivityPrivacy extends BaseActivity {
    ...
    private void showDia(final ArrayList<PrivacyJunkInfo> deleteList) {
        ...
        dialog = new AlertDialog.Builder(DocActivityPrivacy.this).create();
        dialog.setView(view);
        dialog.show();
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (PrivacyJunkInfo info : deleteList) {
                    size += info.size;
                    UtilsFile.deleteCo(DocActivityPrivacy.this, fc_clean, info._id);
                }
                new Thread() {
                    @Override
                    public void run() {
                        super.run();
                        for (PrivacyJunkInfo info : deleteList) {
                            boolean deleteSuce = UtilsFile.deleteFile(DocActivityPrivacy.this, info.path);
                            if (!deleteSuce) {
                ...
                Intent intent = new Intent(DocActivityPrivacy.this, PrivacySucceedActivity.class);
