...
import com.myboost.junk.privacybroadcasts.BoostUnloadResidualBroadcast;
...
public class BoostSetActivity extends BaseActivity {
    ...
    private void initData() {
        if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHI_SWITCH, true)) {
        ...
        if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHILAN_SWITCH, true)) {
        ...
        if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.FlOAT_SWITCH, true)) {
        ...
        if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.UNLOAD_SWITCH, true)) {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.setting_tongzhi:
                    ...
                    if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHI_SWITCH, true)) {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHI_SWITCH, false);
                        setting_tongzhi_check.setImageResource(R.mipmap.side_check_normal);
                    } else {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHI_SWITCH, true);
                        setting_tongzhi_check.setImageResource(R.mipmap.side_check_passed);
                    }
                    break;
                case R.id.setting_tongzhilan:
                    ...
                    if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHILAN_SWITCH, true)) {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHILAN_SWITCH, false);
                        setting_tongzhilan_check.setImageResource(R.mipmap.side_check_normal);
                        Intent intent = new Intent(BoostSetActivity.this, NotificationServiceBoost.class);
                        stopService(intent);
                    } else {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.TONGZHILAN_SWITCH, true);
                        setting_tongzhilan_check.setImageResource(R.mipmap.side_check_passed);
                        Intent intent = new Intent(BoostSetActivity.this, NotificationServiceBoost.class);
                ...
                case R.id.setting_float:
                    ...
                    if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.FlOAT_SWITCH, true)) {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.FlOAT_SWITCH, false);
                        Intent intent1 = new Intent(BoostSetActivity.this, SuspensionBallServiceBoost.class);
                        setting_float_check.setImageResource(R.mipmap.side_check_normal);
                        stopService(intent1);
                    } else {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.FlOAT_SWITCH, true);
                        Intent intent1 = new Intent(BoostSetActivity.this, SuspensionBallServiceBoost.class);
                        setting_float_check.setImageResource(R.mipmap.side_check_passed);
                ...
                case R.id.setting_unload:
                    ...
                    if (PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.UNLOAD_SWITCH, true)) {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.UNLOAD_SWITCH, false);
                        Intent intent1 = new Intent(BoostSetActivity.this, BoostUnloadResidualBroadcast.class);
                        setting_unload_check.setImageResource(R.mipmap.side_check_normal);
                        stopService(intent1);
                    } else {
                        PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.UNLOAD_SWITCH, true);
                        Intent intent1 = new Intent("com.privacy.junk.privacybroadcasts.BoostUnloadResidualBroadcast");
                        setting_unload_check.setImageResource(R.mipmap.side_check_passed);
                ...
                case R.id.setting_short:
                    ...
                    PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.KEY_SHORTCUT, true);
                    PrivacyShortCutUtils.addShortcut(BoostSetActivity.this);
                    break;
                ...
                case R.id.setting_file:
                    ...
                    PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.FILE_CLEAN, true);
                ...
                case R.id.setting_picture:
                    ...
                    PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.PHOTO_CLEAN, true);
                ...
                case R.id.setting_gboost:
                    ...
                    PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.GBOOST_CLEAN, true);
                ...
                case R.id.setting_notifi:
                    ...
                    PreData.putDB(BoostSetActivity.this, MyConstantPrivacy.NOTIFI_CLEAN, true);
                    if (!PreData.getDB(BoostSetActivity.this, MyConstantPrivacy.KEY_NOTIFI, true) || !MyUtils.isNotificationListenEnabled(BoostSetActivity.this)) {
                        //通知栏动画
                ...
                case R.id.setting_rotate:
                    ...
                    PrivacyUtilGp.rate(BoostSetActivity.this);
                    break;
            }
        }
    };
