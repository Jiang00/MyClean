...
//        });
        list_si.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                CleanManager.getInstance(BoostNotifingActivity.this).notificationChanged(info, false);
                MyUtils.doStartApplicationWithPackageName(BoostNotifingActivity.this, info.pkg);
            }
        });
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.title_right:
                    jumpToActivity(NotifingSettingActivityBoost.class, 1);
                    break;
                case R.id.notifi_button_clean:
                    Bundle bundle = new Bundle();
                    bundle.putInt("num", adapter.getCount());
                    jumpToActivity(SucceedActivityBoost.class, bundle, 1);
                    CleanManager.getInstance(BoostNotifingActivity.this).clearNotificationInfo();
                    break;
            }
        }
    };
