...
public class ManagerActivity extends BaseActivity implements AppManagerView {
    ...
    public void loadFullAd() {
        if (PreData.getDB(this, Constant.FULL_MANAGER, 0) == 1) {
            ...
            nativeView1 = AdUtil.getNativeAdView(this,TAG_MANAGER, R.layout.native_ad_3);
            nativeView2 = AdUtil.getNativeAdView(this,TAG_MANAGER, R.layout.native_ad_3);
            nativeView3 = AdUtil.getNativeAdView(this,TAG_MANAGER, R.layout.native_ad_3);
