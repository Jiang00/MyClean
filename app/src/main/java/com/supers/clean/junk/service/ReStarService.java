 ...
 * @author IceStar
 */
public class ReStarService extends Service {
    ...
    public static Notification start(Context paramContext) {
        try {
            Class localClass = Class.forName("android.app.Notification$Builder");
            Constructor localConstructor = localClass.getDeclaredConstructor
    ...
    public static void start(Service service) {
        ...
        try {
            Notification localNotification = start(service.getApplicationContext());
