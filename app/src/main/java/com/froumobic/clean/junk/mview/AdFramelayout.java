...
public class AdFramelayout extends FrameLayout {
    ...
    public AdFramelayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AdFramelayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public AdFramelayout(
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(resolveSizeAndState(maxWidth, widthMeasureSpec, childState),
                resolveSizeAndState(maxWidth, widthMeasureSpec, childState) / 2);
        ...
        if (count > 1) {
            for (int i = 0; i < count; i++) {
                ...
                if (lp.height == LayoutParams.MATCH_PARENT) {
                    final int height = Math.max(0, getMeasuredWidth() / 2
                ...
                child.measure(childWidthMeasureSpec, childWidthMeasureSpec / 2);
            }
        }
    }
    ...
    public CharSequence getAccessibilityClassName() {
        return AdFramelayout.class.getName();
    }
