package com.froumobic.clean.junk.Zwidget;
...
public class WidgetProvider extends AutoUpdateWidgetProvider {
    public static final String WIDGET_PROVIDER_ACTION = "app.froumobi.action.widget.ram";
    public static final String WIDGET_PROVIDER_UPDATE = "app.froumobi.action.widget.update";
