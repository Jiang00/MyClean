...
import com.froumobic.clean.junk.adapter.RecycleViewAdapter;
...
public class PhotoActivity extends MBaseActivity {
    ...
    protected void findId() {
        ...
        picture_num = (TextView) findViewById(R.id.picture_num);
            ...
            switch (msg.what) {
                ...
                case PICTHRE_SUCC:
                    ...
                    if (adapter == null || adapter.getItemCount() == 0) {
                        ...
                        picture_num.setVisibility(View.GONE);

                        picture_scan.setText("");
                    } else {
                        picture_scan.setText(R.string.picture_jianyi);
                        Animation animation1 = AnimationUtils.loadAnimation(PhotoActivity.this, R.anim.translate_notifi);
                        picture_button.startAnimation(animation1);
                        picture_button.setVisibility(View.VISIBLE);
                        picture_num.setText(getString(R.string.picture_xuanzhong) + "( " + msg.arg1 + " )");
                    }
                    break;
                default:
                    break;
    ...
    public void bigPicture(final ArrayList<ImageInfo> list) {
        ...
        pic_pager_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int position = picture_pager.getCurrentItem();
                RecyclerDbHelper.getInstance(PhotoActivity.this).putImageToRecycler(list.get(position));
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
//                    final Bitmap bitma = imageHelper.getImageThumbnail(PhotoActivity.this, list.get(finalI).originId, MediaStore.Images.Thumbnails.FULL_SCREEN_KIND);
                    final Bitmap bitma = imageHelper.pathWithScaledBitmap(PhotoActivity.this, list.get(finalI).path);
                    //final Bitmap bitma = imageHelper.getImageThumbnail(PhotoActivity.this, list.get(finalI).originId, MediaStore.Images.Thumbnails.FULL_SCREEN_KIND);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.title_right:
                    ...
                    jumpToActivity(PhotoHuiActivity.class, 1);
                    break;
    ...
    public void updateUi() {
        ...
        picture_num.setText(getString(R.string.picture_xuanzhong) + "( " + count + " )");
...
//                        adapter.addData(list_item, 0);
                        ...
                        if (adapter == null) {
                            adapter = new RecycleViewAdapter(PhotoActivity.this, totalSimilarImage, imageHelper, mHandler);
