package com.security.cleaner.presenter;
...
import com.security.cleaner.activity.FloatActivity;
import com.security.cleaner.myview.FloatStateView;
...
public class FloatMemoryManager {
    ...
    private FloatMemoryManager(final Context context) {
...
//                removeWindowsView();
    ...
    private static FloatMemoryManager instance;

    public static FloatMemoryManager getInstance(Context context) {
        if (instance == null) {
            instance = new FloatMemoryManager(context);
        }
        return instance;
    }
