...
import com.security.cleaner.activity.MyApplication;
...
public class JunkRamPresenter extends BasePresenter<LajiRamView> {
    private MyApplication cleanApplication;
    private ArrayList<JunkInfo> clearList;
    private long allSize;
    private long cleanSize;

    public JunkRamPresenter(LajiRamView iView, Context context) {
        super(iView, context);
