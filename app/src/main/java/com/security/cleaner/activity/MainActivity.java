...
import com.security.cleaner.madapter.MSideAdapter;
import com.security.cleaner.entity.SideInfo;
import com.security.cleaner.myview.BubbleCenterLayout;
import com.security.cleaner.myview.LineRam;
import com.security.cleaner.myview.MyScrollView;
import com.security.cleaner.myview.PullToRefreshLayout;
import com.security.cleaner.presenter.MainPresenter;
...
import com.security.cleaner.view.MainView;
...
import com.security.module.mView.BubbleLayout;
...
public class MainActivity extends BaseActivity implements MainView, DrawerLayout.DrawerListener {
    ...
    private String TAG_START_FULL = "security_start_native";
...
//            showBatteryDialog();
//        }
        int rotate_c = PreData.getDB(this, Constant.ROTATE_DIALOG, 0);
        if (rotate_c == 3) {
            rotate_c++;
            PreData.putDB(this, Constant.ROTATE_DIALOG, rotate_c);
            showRotateDialog();
        } else if (rotate_c < 3) {
            rotate_c++;
            PreData.putDB(this, Constant.ROTATE_DIALOG, rotate_c);
...
//                }, 2000);
    ...
    private void showRotateDialog() {
        ...
        TextView bt_queren = (TextView) view.findViewById(R.id.bt_queren);
        TextView bt_quxiao = (TextView) view.findViewById(R.id.bt_quxiao);
    ...
    private void showBatteryDialog() {
        ...
        Button battery_button = (Button) view.findViewById(R.id.battery_button);
        ImageView battery_cha = (ImageView) view.findViewById(R.id.battery_cha);
  ...
  /*  public void loadValueAnimator(ValueAnimator animation) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.main_file_qiu:
                    ...
                    mainPresenter.jumpToActivity(FilesManagerActivity.class, 1);
                    break;
                case R.id.main_ram_qiu:
                    AdUtil.track("主页面", "点击ram球进入内存加速页面", "", 1);
                    mainPresenter.jumpToActivity(ARamAvtivity.class, 1);
                    break;
                case R.id.main_junk_button:
                    AdUtil.track("主页面", "点击垃圾清理按钮", "", 1);
                    mainPresenter.jumpToActivity(JunkFileActivity.class, 1);
                    break;
                ...
                case R.id.main_theme_button:
                    ...
                    mainPresenter.jumpToActivity(GameGboostActivity.class, 1);
                    break;
                case R.id.lot_ad:
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Constant.SETTING_RESUIL) {
            ...
            if (Util.isNotificationListenEnabled(MainActivity.this)) {
                ...
                Intent intent = new Intent(MainActivity.this, NotifiPermissActivity.class);
                startActivityForResult(intent, 1);
            }
    ...
    private void showExitDialog() {
        ...
        if (PreData.getDB(this, Constant.FULL_EXIT_NATIVE, 0) == 1) {
