...
public class AppManagerActivity extends BaseActivity implements AppManagerView {
    ...
    private String TAG_MANAGER = "my_manager";
            ...
            switch (v.getId()) {
                ...
                case R.id.manager_shouquan:
                    ...
                    myHandler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent transintent = new Intent(AppManagerActivity.this, PermissionActivity.class);
