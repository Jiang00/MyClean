...
import com.security.cleaner.madapter.NotifiAdapter;
...
public class NotificationActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        title_right.setImageResource(R.mipmap.notifi_setting);
...
//                CleanManager.getInstance(NotificationActivity.this).notificationChanged(info, false);
//            }
//        });
        list_si.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                CleanManager.getInstance(NotificationActivity.this).notificationChanged(info, false);
                Util.doStartApplicationWithPackageName(NotificationActivity.this, info.pkg);
            }
        });
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.notifi_button_clean:
                    ...
                    CleanManager.getInstance(NotificationActivity.this).clearNotificationInfo();
                    break;
            }
        }
    };
