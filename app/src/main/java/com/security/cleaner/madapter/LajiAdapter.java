...
public class LajiAdapter extends MybaseAdapter<JunkInfo> {
    AllListener listener;
    LajiPresenter junkPresenter;

    public LajiAdapter(Context context) {
        super(context);
    }

    public LajiAdapter(Context context, LajiPresenter junkPresenter) {
        super(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (info.type == JunkInfo.TableType.APKFILE) {
            ...
            if (drawable == null) {
                drawable = context.getResources().getDrawable(R.mipmap.file_apk_button);
            }
            ...
            holder.name.setText(info.label);
            holder.icon.setImageResource(R.mipmap.file_txt_button);
        }
