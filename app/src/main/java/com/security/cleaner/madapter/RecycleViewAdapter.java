...
import com.security.cleaner.myview.MyGridLayoutManager;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.MyViewHolder> {
    ...
    private SimilarPhotoActivity pictureActivity;
    ...
    public RecycleViewAdapter(SimilarPhotoActivity pictureActivity, ArrayList<ArrayList<ImageInfo>> totalSimilarImage, ImageHelper imageHelper, Handler handler) {
