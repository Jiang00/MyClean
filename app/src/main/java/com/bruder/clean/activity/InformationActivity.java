...
import com.bruder.clean.util.CameraUtils;
...
public class InformationActivity extends BaseActivity {
    ...
    private void addAd() {
        View nativeView = UtilAd.getNativeAdView(TAG_MESSAGE, R.layout.native_ad_3);
    ...
    private void loadAd() {
        if (DataPre.getDB(this, Constant.FULL_MESSAGE, 0) == 1) {
