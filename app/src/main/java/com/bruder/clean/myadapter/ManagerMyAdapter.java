...
public class ManagerMyAdapter extends MybaseAdapter<JunkInfo> {
    AllListener listener;
    ManagerPresenter managerPresenter;

    public ManagerMyAdapter(Context context) {
        super(context);
    }

    public ManagerMyAdapter(Context context, ManagerPresenter managerPresenter) {
        super(context);
