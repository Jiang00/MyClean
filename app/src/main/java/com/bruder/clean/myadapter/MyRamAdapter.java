...
public class MyRamAdapter extends MybaseAdapter<JunkInfo> {
    AllListener listener;
    RamPresenter ramPresenter;
    private List<String> white_list;
    private AlertDialog dialog;

    public MyRamAdapter(Context context) {
        super(context);
    }

    public MyRamAdapter(Context context, RamPresenter ramPresenter) {
        super(context);
...
//                    ((PhoneRamAvtivity) context).myHandler.post(new Runnable() {
//                        @Override
//                        public void run() {
