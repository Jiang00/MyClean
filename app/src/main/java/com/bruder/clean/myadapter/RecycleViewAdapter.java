...
import com.bruder.clean.customeview.ManagerMyGridLayout;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.MyViewHolder> {
    ...
    private PicturesActivity pictureActivity;
    private ImageHelper imageHelper;
    private ManagerMyGridLayout gridLayoutManager;
    ...
    public RecycleViewAdapter(PicturesActivity pictureActivity, ArrayList<ArrayList<ImageInfo>> totalSimilarImage, ImageHelper imageHelper, Handler handler) {
    ...
    private void addItemView(MyViewHolder holder, ArrayList<ImageInfo> list) {
        ...
        gridLayoutManager = new ManagerMyGridLayout(pictureActivity, 3);
