...
public class CustomRoundCpuView extends View {
    ...
    public CustomRoundCpuView(Context context) {
        this(context, null);
    }

    public CustomRoundCpuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomRoundCpuView(Context context, AttributeSet attrs, int defStyleAttr) {
