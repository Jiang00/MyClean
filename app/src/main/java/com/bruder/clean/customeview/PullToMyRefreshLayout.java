 ...
 * @author 陈靖
 */
public class PullToMyRefreshLayout extends RelativeLayout {
...
//    private TextView loadStateTextView;
    ...
    public PullToMyRefreshLayout(Context context) {
        super(context);
        initView(context);
    }

    public PullToMyRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public PullToMyRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
...
//                loadStateTextView.setText("正在加载");
            ...
            case MotionEvent.ACTION_MOVE:
                if (mEvents == 0) {
                    if (pullDownY > 0
                        ...
                        if (pullUpY < -loadmoreDist * 2) {
                            pullUpY = -loadmoreDist * 2;
                            canPullDown = false;
                            canPullUp = true;
                        }
    ...
    private class AutoRefreshAndLoadTask extends
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(PullToMyRefreshLayout.this);
            hide();
        }
    ...
    private void initView() {
        // 初始化下拉布局
        pullView = refreshView.findViewById(R.id.iv_jiantou);
//        refreshStateTextView = (TextView) refreshView
//                .findViewById(R.id.state_tv);
        refreshingView = refreshView.findViewById(R.id.iv_shuaxin);
        refreshStateImageView = refreshView.findViewById(R.id.iv_success);
        // 初始化上拉布局
        pullUpView = loadmoreView.findViewById(R.id.iv_jiantou);
//        loadStateTextView = (TextView) loadmoreView
//                .findViewById(R.id.loadstate_tv);
        loadingView = loadmoreView.findViewById(R.id.iv_shuaxin);
        loadStateImageView = loadmoreView.findViewById(R.id.iv_success);
    }
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(PullToMyRefreshLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(PullToMyRefreshLayout pullToRefreshLayout);
    }
