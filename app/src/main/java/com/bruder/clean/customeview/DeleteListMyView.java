...
public class DeleteListMyView extends ListView {
    /**
    ...
    public DeleteListMyView(Context context) {
        this(context, null);
    }

    public DeleteListMyView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DeleteListMyView(Context context, AttributeSet attrs, int defStyle) {
