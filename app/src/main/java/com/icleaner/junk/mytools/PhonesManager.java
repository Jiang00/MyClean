...
public class PhonesManager {
    ...
    private static PhonesManager systemManager;

    private PhonesManager(Context context) {
...
//		am = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static PhonesManager getPhoneManage(Context context) {
        if (systemManager == null) {
            systemManager = new PhonesManager(context);
        }
