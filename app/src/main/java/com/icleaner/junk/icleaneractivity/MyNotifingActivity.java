...
import com.icleaner.junk.mycustomadapter.NotifiAdapter;
...
public class MyNotifingActivity extends Activity {
    TextView title_name;
    ...
    protected void findId() {
        ...
        notifi_button_clean = (ImageView) findViewById(R.id.notifi_button_clean);
    }
...
//                CleanManager.getInstance(MyNotifingActivity.this).notificationChanged(info, false);
//            }
//        });
        list_si.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                CleanManager.getInstance(MyNotifingActivity.this).notificationChanged(info, false);
                MyUtils.doStartApplicationWithPackageName(MyNotifingActivity.this, info.pkg);
            }
        });
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.title_right:
                    jumpToActivity(MyNotifingSettingActivity.class, 1);
                    break;
                case R.id.notifi_button_clean:
                    Bundle bundle = new Bundle();
                    bundle.putInt("num", adapter.getCount());
                    jumpToActivity(SucceedActivity.class, bundle, 1);
                    CleanManager.getInstance(MyNotifingActivity.this).clearNotificationInfo();
                    break;
            }
        }
    };
