...
public class PhoneFileActivity extends BaseActivity {
    ...
    public static final String TAG = "PhoneFileActivity";
    ...
    private String name;
    private String Tag_file_1 = "icleaner_file_1";
    ...
    private void showDia(final ArrayList<JunkInfo> deleteList) {
        ...
        dialog = new AlertDialog.Builder(PhoneFileActivity.this).create();
        dialog.setView(view);
        dialog.show();
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (JunkInfo info : deleteList) {
                    size += info.size;
                    UtilsFile.deleteCo(PhoneFileActivity.this, fc, info._id);
                }
                new Thread() {
                    @Override
                    public void run() {
                        super.run();
                        for (JunkInfo info : deleteList) {
                            boolean deleteSuce = UtilsFile.deleteFile(PhoneFileActivity.this, info.path);
                            if (!deleteSuce) {
                ...
                adapter.notifyDataSetChanged();
                Intent intent = new Intent(PhoneFileActivity.this, SucceedActivity.class);
