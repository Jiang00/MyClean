...
public class IgnoresAvtivity extends BaseActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.title_right:
                    Intent intent = new Intent(IgnoresAvtivity.this, IgnoresAddActivity.class);
                    IgnoresAvtivity.this.startActivityForResult(intent, 1);
                    break;
            }
        }
    };
