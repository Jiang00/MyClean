...
import com.icleaner.junk.mytools.GetCameraUtils;
...
public class PhonesMessageActivity extends BaseActivity {
    TextView title_name;
    ...
    private String TAG_MESSAGE = "icleaner_message";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                final String q = GetCameraUtils.getCameraPixels(GetCameraUtils.HasFrontCamera());
                final String h = GetCameraUtils.getCameraPixels(GetCameraUtils.HasBackCamera());
    ...
    private void addAd() {
        View nativeView = SetAdUtil.getNativeAdView(TAG_MESSAGE, R.layout.native_ad_3);
