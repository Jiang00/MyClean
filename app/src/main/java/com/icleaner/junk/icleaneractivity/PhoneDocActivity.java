...
import com.icleaner.clean.filemanager.UtilsFile;
...
import com.icleaner.junk.mycustomadapter.PhoneFileAdapter;
import com.icleaner.junk.shitis.JunkInfo;
...
public class PhoneDocActivity extends BaseActivity {

    private static final String TAG = "PhoneDocActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter_doc = new PhoneFileAdapter(this);
        adapter_txt = new PhoneFileAdapter(this);
        adapter_pdf = new PhoneFileAdapter(this);
    ...
    private void showDia(final ArrayList<JunkInfo> deleteList) {
        ...
        dialog = new AlertDialog.Builder(PhoneDocActivity.this).create();
        dialog.setView(view);
        dialog.show();
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (JunkInfo info : deleteList) {
                    size += info.size;
                    UtilsFile.deleteCo(PhoneDocActivity.this, fc_clean, info._id);
                }
                new Thread() {
                    @Override
                    public void run() {
                        super.run();
                        for (JunkInfo info : deleteList) {
                            boolean deleteSuce = UtilsFile.deleteFile(PhoneDocActivity.this, info.path);
                            if (!deleteSuce) {
                ...
                Intent intent = new Intent(PhoneDocActivity.this, SucceedActivity.class);
        ...
        if (cursorDoc != null && cursorDoc.moveToFirst()) {
            do {
                ...
                if (fc == PhoneFileCategoryHelper.FileCategory.Word) {
                    icon = ContextCompat.getDrawable(PhoneDocActivity.this, R.mipmap.file_doc_icon);
                } else if (fc == PhoneFileCategoryHelper.FileCategory.Txt) {
                    icon = ContextCompat.getDrawable(PhoneDocActivity.this, R.mipmap.file_txt_icon);
                } else if (fc == PhoneFileCategoryHelper.FileCategory.Pdf) {
                    icon = ContextCompat.getDrawable(PhoneDocActivity.this, R.mipmap.file_pd_icon);
                }
