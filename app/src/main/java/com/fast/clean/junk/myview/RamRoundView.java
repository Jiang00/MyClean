...
public class RamRoundView extends View {

    float lineWidth = getResources().getDimension(R.dimen.d9);
    ...
    public RamRoundView(Context context) {
        this(context, null);
    }

    public RamRoundView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RamRoundView(Context context, AttributeSet attrs, int defStyleAttr) {
