...
public class EasyNotifingActivity extends Activity {
    TextView title_name;
    ...
    private void setListener() {
        ...
        list_si.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                CleanManager.getInstance(EasyNotifingActivity.this).notificationChanged(info, false);
                MyUtils.doStartApplicationWithPackageName(EasyNotifingActivity.this, info.pkg);
            }
        });
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.title_right:
                    jumpToActivity(EasyNotifingSettingActivity.class, 1);
                    break;
                case R.id.notifi_button_clean:
                    Bundle bundle = new Bundle();
                    bundle.putInt("num", adapter.getCount());
                    jumpToActivity(EasySucceedActivity.class, bundle, 1);
                    CleanManager.getInstance(EasyNotifingActivity.this).clearNotificationInfo();
                    break;
            }
        }
    };
