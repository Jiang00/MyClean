...
public class EasyDocActivity extends BaseActivity {
    ...
    private void showDia(final ArrayList<EasyJunkInfo> deleteList) {
        ...
        dialog = new AlertDialog.Builder(EasyDocActivity.this).create();
        dialog.setView(view);
        dialog.show();
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EasyDocActivity.this, EasySucceedActivity.class);
        ...
        if (cursorDoc != null && cursorDoc.moveToFirst()) {
            do {
                ...
                if (fc == PhoneFileCategoryHelper.FileCategory.Word) {
                    icon = ContextCompat.getDrawable(EasyDocActivity.this, R.mipmap.file_doc_icon);
                } else if (fc == PhoneFileCategoryHelper.FileCategory.Txt) {
                    icon = ContextCompat.getDrawable(EasyDocActivity.this, R.mipmap.file_txt_icon);
