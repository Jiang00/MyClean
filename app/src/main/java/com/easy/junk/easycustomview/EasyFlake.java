...
public class EasyFlake {
     ...
     */
    static EasyFlake createFlake(float xRange, Bitmap originalBitmap) {
        EasyFlake flake = new EasyFlake();
    ...
    static EasyFlake createFlake(float xRange, Bitmap originalBitmap, int from) {
        EasyFlake flake = new EasyFlake();
        // Size each flake with a width between 5 and 55 and a proportional height
