...
public class YuanHuViewNotifi extends View {
    Paint paint;
    RectF rectF;
    Context context;
    float dushu;
    ...
    public YuanHuViewNotifi(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        }
    ...
    private YuanHuViewNotifi.DrawYuanHuListener scanEndListener;

    public void setScanCallBack(YuanHuViewNotifi.DrawYuanHuListener listener) {
