...
public class EasySlowScrollView extends ScrollView {

    private Scroller mScroller;

    public EasySlowScrollView(Context context) {
        super(context);
        mScroller = new Scroller(context);
    }

    public EasySlowScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mScroller = new Scroller(context);
    }

    public EasySlowScrollView(Context context, AttributeSet attrs, int defStyle) {
