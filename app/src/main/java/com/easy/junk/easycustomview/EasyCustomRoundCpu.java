...
public class EasyCustomRoundCpu extends View {
    ...
    public EasyCustomRoundCpu(Context context) {
        this(context, null);
    }

    public EasyCustomRoundCpu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EasyCustomRoundCpu(Context context, AttributeSet attrs, int defStyleAttr) {
