...
public class EasyLog extends EasyBaseAdapter<JunkInfo> {
    LogPresenter junkPresenter;
    AllListener listener;
    String cleanName;

    public EasyLog(Context context) {
        super(context);
    }

    public EasyLog(Context context, LogPresenter junkPresenter, String cleanName) {
        super(context);
