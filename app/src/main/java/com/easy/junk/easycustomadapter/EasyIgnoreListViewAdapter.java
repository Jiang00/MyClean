...
public class EasyIgnoreListViewAdapter extends EasyBaseAdapter<JunkInfo> {
    private Toast toast;

    public EasyIgnoreListViewAdapter(Context context) {
        super(context);
    }
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (info.isWhiteList) {
                    ...
                    SetAdUtil.track("白名单页面", "选中" + info.label, "", 1);
                } else {
