...
public class EasyPresenterMain extends PresenterBase<MainView> {
    ...
    public EasyPresenterMain(MainView iView, Context context) {
        super(iView, context);
        this.iView = iView;
    ...
    public void clickRotate(boolean isGood) {
        ...
        PreData.putDB(context, EasyConstant.IS_ROTATE, true);
        setRotateGone();
    }
