...
import com.upupup.clean.imageclean.ImageHelper;
import com.upupup.clean.imageclean.ImageInfo;
...
import com.upupup.clean.junk.myAdapter.RecycleViewAdapter;
import com.upupup.clean.imageclean.RecyclerDbHelper;
...
public class SimilarActivity extends BaseActivity {
            ...
            switch (msg.what) {
                ...
                case PICTHRE_SUCC:
                    ...
                    if (adapter == null || adapter.getItemCount() == 0) {
                        ...
                        Animation animation1 = AnimationUtils.loadAnimation(SimilarActivity.this, R.anim.translate_notifi);
    ...
    public void bigPicture(final ArrayList<ImageInfo> list) {
        ...
        pic_pager_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int position = picture_pager.getCurrentItem();
                RecyclerDbHelper.getInstance(SimilarActivity.this).putImageToRecycler(list.get(position));
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
//                    final Bitmap bitma = imageHelper.getImageThumbnail(SimilarActivity.this, list.get(finalI).originId, MediaStore.Images.Thumbnails.FULL_SCREEN_KIND);
                    final Bitmap bitma = imageHelper.pathWithScaledBitmap(SimilarActivity.this, list.get(finalI).path);
                    //final Bitmap bitma = imageHelper.getImageThumbnail(SimilarActivity.this, list.get(finalI).originId, MediaStore.Images.Thumbnails.FULL_SCREEN_KIND);
...
//                        adapter.addData(list_item, 0);
                        ...
                        if (adapter == null) {
                            adapter = new RecycleViewAdapter(SimilarActivity.this, totalSimilarImage, imageHelper, mHandler);
