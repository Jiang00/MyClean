...
import com.upupup.clean.junk.myview.MyGridLayoutManager;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.MyViewHolder> {
    ...
    private SimilarActivity pictureActivity;
    ...
    public RecycleViewAdapter(SimilarActivity pictureActivity, ArrayList<ArrayList<ImageInfo>> totalSimilarImage, ImageHelper imageHelper, Handler handler) {
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.HomeViewHolder> {
        ...
        public void onBindViewHolder(final HomeAdapter.HomeViewHolder holder, final int position) {
            ...
            if (info.isNormal) {
                ...
                holder.picture_yinying.setVisibility(View.GONE);
            } else {
                holder.picture_check.setImageResource(R.mipmap.ram_passed);
                holder.picture_yinying.setVisibility(View.VISIBLE);
            }
...
//            imageLoad.execute(info.path, info.name);
        ...
        class HomeViewHolder extends RecyclerView.ViewHolder {
            ...
            public HomeViewHolder(View view) {
                ...
                picture_yinying = (ImageView) view.findViewById(R.id.picture_yinying);
            }
        }
