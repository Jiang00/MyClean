...
import com.upupup.clean.deepclean.CustomerAccessibilityService;
import com.upupup.clean.junk.myview.WidgetContainer;
...
import com.upupup.clean.junk.myview.PowerWidgetContainer;
...
//                showPackageDetail(startList.get(0).packageName);
    ...
    public void permissIntent() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                View view = LayoutInflater.from(PowerActivity.this).inflate(R.layout.layout_power_permission, null);
