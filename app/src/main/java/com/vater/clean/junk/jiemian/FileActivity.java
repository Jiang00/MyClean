...
public class FileActivity extends BaseActivity {
    ...
    private String name;
    private String Tag_file_1 = "vater_file_1";
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (JunkInfo info : deleteList) {
                    size += info.size;
                    FileUtils.deleteCo(FileActivity.this, fc, info._id);
                }
                new Thread() {
                    @Override
                    public void run() {
                        super.run();
                        for (JunkInfo info : deleteList) {
                            boolean deleteSuce = FileUtils.deleteFile(FileActivity.this, info.path);
                            if (!deleteSuce) {
                ...
                adapter.notifyDataSetChanged();
                Intent intent = new Intent(FileActivity.this, SuccessActivity.class);
