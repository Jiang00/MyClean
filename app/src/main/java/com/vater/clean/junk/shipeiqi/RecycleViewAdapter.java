...
import com.vater.clean.junk.myview.MyGridLayoutManager;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.MyViewHolder> {
    private SimerActivity pictureActivity;
    ...
    public RecycleViewAdapter(SimerActivity pictureActivity, ArrayList<ArrayList<ImageInfo>> totalSimilarImage, ImageHelper imageHelper, Handler handler) {
    ...
    private void addItemView(MyViewHolder holder, ArrayList<ImageInfo> list) {
        ...
        gridLayoutManager = new MyGridLayoutManager(pictureActivity, 2);
