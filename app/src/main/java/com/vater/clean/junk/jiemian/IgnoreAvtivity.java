...
import com.vater.clean.junk.shipeiqi.IgnoreListAdapter;
...
public class IgnoreAvtivity extends BaseActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.title_right:
                    Intent intent = new Intent(IgnoreAvtivity.this, IgnoreAddActivity.class);
                    IgnoreAvtivity.this.startActivityForResult(intent, 1);
                    break;
            }
        }
    };
