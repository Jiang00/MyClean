...
public class SettingActivity extends BaseActivity {
    ...
    private String TAG_SETTING = "vater_setting";
            ...
            switch (v.getId()) {
                ...
                case R.id.setting_battery:
                    ...
                    if ((boolean) Utils.readData(SettingActivity.this, Constants.CHARGE_SAVER_SWITCH, true)) {
                        ...
                        PreData.putDB(SettingActivity.this, Constant.FIRST_BATTERY, false);
                        setting_battery_check.setImageResource(R.mipmap.side_check_passed);
                    }
                    break;
                case R.id.setting_white:
                    AdUtil.track("设置页面", "进入白名单", "", 1);
                    Intent intent = new Intent(SettingActivity.this, IgnoreAvtivity.class);
                ...
                case R.id.setting_picture:
                    ...
                    Intent intentPic = new Intent(SettingActivity.this, SimerActivity.class);
                ...
                case R.id.setting_hui:
                    ...
                    Intent intenth = new Intent(SettingActivity.this, SimerHuiActivity.class);
                ...
                case R.id.setting_rotate:
                    ...
                    MUtilGp.rate(SettingActivity.this);
                    break;
            }
        }
    };
