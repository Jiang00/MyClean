...
import com.frigate.attr.Attrs;
import com.frigate.attr.AutoAttr;
...
public class AutoLayoutInfo {
    ...
    public static AutoLayoutInfo getAttrFromView(View view, int attrs, int base) {
        ...
        if ((attrs & Attrs.ELEVATION) != 0) {
            autoLayoutInfo.addAttr(ElevationAttr.generate(ElevationAttr.getElevation(view), base));
        }
        //textsize
