...
public class FrigateLinearLayout extends LinearLayout {
    ...
    public FrigateLinearLayout(Context context) {
        this(context, null);
    }

    public FrigateLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public FrigateLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public FrigateLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new FrigateLinearLayout.LayoutParams(getContext(), attrs);
    }
