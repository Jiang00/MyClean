...
public class FrigateRelativeLayout extends RelativeLayout {
    private AutoLayoutHelper mHelper = null;
    Context mContext;
    ...
    public FrigateRelativeLayout(Context context) {
        this(context, null);
    }

    public FrigateRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FrigateRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public FrigateRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
