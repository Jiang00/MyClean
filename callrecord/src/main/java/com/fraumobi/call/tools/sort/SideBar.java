package com.fraumobi.call.tools.sort;
...
public class SideBar extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.Style_SideBar);
            scaleSize = ta.getInteger(R.styleable.Style_SideBar_scaleSize, 1);
            scaleItemCount = ta.getInteger(R.styleable.Style_SideBar_scaleItemCount, 6);
            scaleWidth = ta.getDimensionPixelSize(R.styleable.Style_SideBar_scaleWidth, dp(10));
            ta.recycle();
        }
