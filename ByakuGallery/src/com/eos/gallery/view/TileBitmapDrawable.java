...
public class TileBitmapDrawable extends Drawable {
    ...
    public static LruCache<String, Bitmap> initCache(Context context){
        ...
        synchronized (sBitmapCacheLock) {
            if (sBitmapCache == null) {
                ...
                sBitmapCache = new BitmapLruCache(cacheSize > memory ? cacheSize : memory);
            }
        }
        return sBitmapCache;
    }
...
//            }
    ...
    private static final class InitializationTask extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            ...
            try {
                if (params[0] == null) throw new RuntimeException();
