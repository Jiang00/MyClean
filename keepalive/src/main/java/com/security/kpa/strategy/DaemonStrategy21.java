package com.security.kpa.strategy;
...
import com.security.kpa.DaemonConfigurations;
import com.security.kpa.IDaemonStrategy;
import com.security.kpa.nativ.NativeDaemonAPIL;
    ...
    public void onPersistentCreate(final Context context, DaemonConfigurations configs) {
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                ...
                new NativeDaemonAPIL(context).doDaemon(
