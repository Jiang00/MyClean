...
#include "com_icleanering_kpa_nativ_NativeDaemonAPIL.h"
#include "log.h"
#include "constant.h"
...
JNIEXPORT void JNICALL Java_com_icleanering_kpa_nativ_NativeDaemonAPIL_doDaemon(JNIEnv *env, jobject jobj, jstring indicatorSelfPath, jstring indicatorDaemonPath, jstring observerSelfPath, jstring observerDaemonPath){
