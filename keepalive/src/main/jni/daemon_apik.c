...
#include "log.h"
#include "constant.h"
#include "com_eifmobi_kpa_nativ_NativeDaemonAPIK.h"
...
JNIEXPORT void JNICALL Java_com_eifmobi_kpa_nativ_NativeDaemonAPIK_doDaemon(JNIEnv *env, jobject jobj, jstring pkgName, jstring svcName, jstring daemonPath){
