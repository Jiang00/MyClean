...
import com.achtapps.ui.demo.cross.CrossDialog;
import com.achtapps.ui.demo.cross.CrossView;
import com.achtapps.ui.demo.cross.FloatCrossView;
import com.achtapps.ui.demo.dialog.Builder;
import com.achtapps.ui.demo.dialog.PermanentPraiseView;
import com.achtapps.ui.demo.dialog.VersionOrPraiseDialog;
import com.achtapps.ui.demo.util.Utils;
import com.achtapps.ui.demo.util.WrapNullPointException;
import com.achtapps.ui.demo.view.ExitDialog;
import com.achtapps.ui.demo.view.ExitView;
...
public class UiManager {
    ...
    public static void getCrossView(Context context, com.achtapps.ui.demo.cross.Builder builder,
    ...
    public static void showCrossDialog(final Context context, com.achtapps.ui.demo.cross.Builder builder,
        ...
        builder.setType(com.achtapps.ui.demo.cross.Builder.Type.TYPE_DIALOG);
        ...
        new CrossView(context, builder, new CrossView.OnDataFinishListener() {
            ...
            public void onFinish(CrossView crossView) {
                ...
                ImageView image = (ImageView) crossView.findViewById(com.achtapps.ui.demo.R.id.head);
                if (image != null) {
    ...
    public static void showFloatCrossView(final Context context, final com.achtapps.ui.demo.cross.Builder builder,
