package com.eifmobi.clean.imageclean;
...
import com.eifmobi.clean.filemanager.FileUtils;
...
//        db.endTransaction();
    ...
    private String getRecyclerDirectory(String recyclerTime) {
        return Environment.getExternalStorageDirectory() + "/eifmobi/" + recyclerTime + "/";
    }
    ...
    private void deleteOverDateRecyclerFile() {
        File file = new File(Environment.getExternalStorageDirectory() + "/eifmobi");
