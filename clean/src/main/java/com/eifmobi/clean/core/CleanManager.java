package com.eifmobi.clean.core;
...
import com.eifmobi.clean.callback.AppCacheCallBack;
import com.eifmobi.clean.callback.AppRamCallBack;
import com.eifmobi.clean.callback.FileInfoCallBack;
import com.eifmobi.clean.callback.SystemCacheCallBack;
import com.eifmobi.clean.callback.UninstallResidualCallback;
import com.eifmobi.clean.entity.JunkInfo;
import com.eifmobi.clean.entity.Sizesort;
import com.eifmobi.clean.filemanager.FileCategoryHelper;
import com.eifmobi.clean.filemanager.FileSortHelper;
import com.eifmobi.clean.notifi.NotificationCallBack;
import com.eifmobi.clean.notifi.NotificationInfo;
    ...
    public void loadApkFile(FileInfoCallBack fileInfoCallBack) {
        ...
        if (cursor != null && cursor.getCount() != 0) {
            ...
            do {
                ...
                String name = com.eifmobi.clean.filemanager.Util.getNameFromFilepath(path);
