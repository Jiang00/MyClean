package com.vector.mcleaner.photo;
...
//        db.endTransaction();
    ...
    private String getRecyclerDirectory(String recyclerTime) {
        return Environment.getExternalStorageDirectory() + "/vectorapps/" + recyclerTime + "/";
    }
    ...
    private void deleteOverDateRecyclerFile() {
        File file = new File(Environment.getExternalStorageDirectory() + "/vectorapps");
