package com.privacy.clean.utilsprivacy;
...
import com.privacy.clean.BuildConfig;
...
//            Log.e("aaa", "===first install time : " + MyUtils.getStrTime(firstInstallTime) + " last update time :" + MyUtils.getStrTime(lastUpdateTime));
    ...
    public static Bitmap getViewBitmap(View view) {
        ...
        view.layout(0, 0, MyUtils.dp2px(60), MyUtils.dp2px(60));
    ...
    public static boolean isAccessibilitySettingsOn(Context mContext) {
        ...
        final String service = mContext.getPackageName() + "/" + MyServiceCustomerAccessibility.class.getCanonicalName();
        try {
