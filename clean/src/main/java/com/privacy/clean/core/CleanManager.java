package com.privacy.clean.core;
...
import com.privacy.clean.zcallback.AppCacheCallBack;
import com.privacy.clean.zcallback.AppRamCallBack;
import com.privacy.clean.zcallback.FileInfoCallBack;
import com.privacy.clean.zcallback.SystemCacheCallBack;
import com.privacy.clean.zcallback.UninstallResidualCallback;
import com.privacy.clean.entity.JunkInfo;
import com.privacy.clean.entity.Sizesort;
    ...
    public void loadApkFile(FileInfoCallBack fileInfoCallBack) {
        ...
        if (cursor != null && cursor.getCount() != 0) {
            ...
            do {
                ...
                String name = com.privacy.clean.filemanager.Util.getNameFromFilepath(path);
