...
import com.upupup.clean.callback.AppCacheCallBack;
import com.upupup.clean.callback.AppRamCallBack;
import com.upupup.clean.callback.FileInfoCallBack;
import com.upupup.clean.callback.SystemCacheCallBack;
import com.upupup.clean.callback.UninstallResidualCallback;
import com.upupup.clean.entity.JunkInfo;
import com.upupup.clean.entity.Sizesort;
import com.upupup.clean.filemanager.FileCategoryHelper;
import com.upupup.clean.filemanager.FileSortHelper;
import com.upupup.clean.notifi.NotificationCallBack;
import com.upupup.clean.notifi.NotificationInfo;
    ...
    public void loadApkFile(FileInfoCallBack fileInfoCallBack) {
        ...
        if (cursor != null && cursor.getCount() != 0) {
            ...
            do {
                ...
                String name = com.upupup.clean.filemanager.Util.getNameFromFilepath(path);
