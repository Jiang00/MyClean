...
import com.security.mcleaner.mutil.TopActivityPkg;
...
public class MyCleanService extends Service {
     ...
     */
    public MyCleanService(String name) {
        super();
        mName = name;
    }
    ...
    public void onCreate() {
        ...
        thread.start();
        cleanManager = CleanManager.getInstance(getApplicationContext());
