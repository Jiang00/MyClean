package com.security.mcleaner.manager;
...
import com.security.mcleaner.mCallback.SystemCacheCallBack;
import com.security.mcleaner.mCallback.AppCacheCallBack;
import com.security.mcleaner.mCallback.AppRamCallBack;
import com.security.mcleaner.mCallback.FileInfoCallBack;
import com.security.mcleaner.mCallback.UninstallResidualCallback;
import com.security.mcleaner.entity.JunkInfo;
import com.security.mcleaner.entity.Sizesort;
        ...
        if (listInfo != null) {
            for (AndroidAppProcess info : listInfo) {
                ...
                try {
                    ...
                    if (!Util.isThirdApp(otherInfo) || packageName.equals(mContext.getPackageName()) || packageName.contains("com.security")) {
                        continue;
                    }
