package com.security.mcleaner.file;/*
...
public class FileCategoryHelper {
   ...
   /* static {
    ...
    private static String buildWordSelection() {
        StringBuilder selection = new StringBuilder();
        Iterator<String> iter = FileUtil.sWordMimeTypesSet.iterator();
        while (iter.hasNext()) {
            selection.append("(" + FileColumns.MIME_TYPE + "=='" + iter.next() + "') OR ");
        }
        return selection.substring(0, selection.lastIndexOf(")") + 1);
    ...
    private static String buildSelectionByCategory(FileCategory cat) {
        ...
        switch (cat) {
            ...
            case Word:
                ...
                break;
            case Txt:
                selection = "(" + FileColumns.MIME_TYPE + " == '" + FileUtil.sTxtMimeTypesSet + "')";
                break;
            case Pdf:
                selection = "(" + FileColumns.MIME_TYPE + " == '" + FileUtil.sPdfMimeTypesSet + "')";
                break;
            case Zip:
//                selection = "(" + FileColumns.MIME_TYPE + " == '" + FileUtil.sZipFileMimeType + "')";
    ...
    public static FileCategory getCategoryFromPath(String path) {
        ...
        if (type != null) {
            ...
            if (FileUtil.sDocMimeTypesSet.contains(type.mimeType)) return FileCategory.Doc;
        }
    ...
    public void refreshCategory() {
        ...
        if (sdCardInfo != null) {
            ...
            Log.e("rqy", "sdcard total:" + FileUtil.convertStorage(sdCardInfo.total));
            Log.e("rqy", "sdcard free:" + FileUtil.convertStorage(sdCardInfo.free));
        }
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                Log.e("rqy", "File_name=" + FileUtil.getNameFromFilepath(cursor.getString(FileCategoryHelper.COLUMN_PATH)));
