...
import com.security.mcleaner.deep.MyAccessibilityService;
import com.security.mcleaner.BuildConfig;
...
//            Log.e("aaa", "===first install time : " + FileUtil.getStrTime(firstInstallTime) + " last update time :" + FileUtil.getStrTime(lastUpdateTime));
