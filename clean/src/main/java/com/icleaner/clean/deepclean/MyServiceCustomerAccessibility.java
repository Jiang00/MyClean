package com.icleaner.clean.deepclean;
 ...
 */
public class MyServiceCustomerAccessibility extends android.accessibilityservice.AccessibilityService {
    ...
    protected void onServiceConnected() {
        ...
        Intent intent = new Intent("com.android.clean.accessibility.event.connected");
        LocalBroadcastManager.getInstance(getApplicationContext()).sendBroadcast(intent);
    }

    @Override
    public boolean onUnbind(Intent intent) {
        Intent unBindIntent = new Intent("com.android.clean.accessibility.event.unbind");
        LocalBroadcastManager.getInstance(getApplicationContext()).sendBroadcast(unBindIntent);
