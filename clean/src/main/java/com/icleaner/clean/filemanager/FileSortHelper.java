...
public class FileSortHelper {
    ...
    private abstract class FileComparator implements Comparator<PhoneFileInfo> {

        @Override
        public int compare(PhoneFileInfo object1, PhoneFileInfo object2) {
        ...
        protected abstract int doCompare(PhoneFileInfo object1, PhoneFileInfo object2);
    }

    private Comparator cmpName = new FileComparator() {
        @Override
        public int doCompare(PhoneFileInfo object1, PhoneFileInfo object2) {
