package com.icleaner.clean.filemanager;/*
...
public class PhoneFileCategoryHelper {
    ...
    private static final String LOG_TAG = "PhoneFileCategoryHelper";
    ...
    public PhoneFileCategoryHelper(Context context) {
    ...
    private static String buildSelectionByCategory(FileCategory cat) {
        ...
        switch (cat) {
            ...
            case Pdf:
                ...
                break;
            case Zip:
//                selection = "(" + FileColumns.MIME_TYPE + " == '" + MyUtils.sZipFileMimeType + "')";
    ...
    public void refreshCategory() {
        ...
        Cursor cursor = query(PhoneFileCategoryHelper.FileCategory.Music, FileSortHelper.SortMethod.size);
        if (cursor != null && cursor.moveToFirst()) {
            do {
                Log.e("rqy", "COLUMN_ID=" + cursor.getLong(PhoneFileCategoryHelper.COLUMN_ID));
                Log.e("rqy", "COLUMN_PATH=" + cursor.getString(PhoneFileCategoryHelper.COLUMN_PATH));
                Log.e("rqy", "File_name=" + Util.getNameFromFilepath(cursor.getString(PhoneFileCategoryHelper.COLUMN_PATH)));
                Log.e("rqy", "COLUMN_SIZE=" + cursor.getString(PhoneFileCategoryHelper.COLUMN_SIZE));
                Log.e("rqy", "COLUMN_DATE=" + cursor.getString(PhoneFileCategoryHelper.COLUMN_DATE));
