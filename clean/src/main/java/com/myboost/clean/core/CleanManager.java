package com.myboost.clean.core;
...
import com.myboost.clean.zcallback.AppCacheCallBack;
import com.myboost.clean.zcallback.AppRamCallBack;
import com.myboost.clean.zcallback.FileInfoCallBack;
import com.myboost.clean.zcallback.SystemCacheCallBack;
import com.myboost.clean.zcallback.UninstallResidualCallback;
import com.myboost.clean.entity.JunkInfo;
import com.myboost.clean.entity.Sizesort;
    ...
    public void loadApkFile(FileInfoCallBack fileInfoCallBack) {
        ...
        if (cursor != null && cursor.getCount() != 0) {
            ...
            do {
                ...
                String name = com.myboost.clean.filemanager.Util.getNameFromFilepath(path);
