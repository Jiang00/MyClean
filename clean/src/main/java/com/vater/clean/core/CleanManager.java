...
import com.vater.clean.callback.AppCacheCallBack;
import com.vater.clean.callback.AppRamCallBack;
import com.vater.clean.callback.FileInfoCallBack;
import com.vater.clean.callback.SystemCacheCallBack;
import com.vater.clean.callback.UninstallResidualCallback;
import com.vater.clean.entity.JunkInfo;
import com.vater.clean.entity.Sizesort;
        ...
        if (listInfo != null) {
            for (AndroidAppProcess info : listInfo) {
                ...
                try {
                    ...
                    if (!Util.isThirdApp(otherInfo) || packageName.equals(mContext.getPackageName()) || packageName.contains("com.vater")) {
                        continue;
                    }
    ...
    public void loadApkFile(FileInfoCallBack fileInfoCallBack) {
        ...
        if (cursor != null && cursor.getCount() != 0) {
            ...
            do {
                ...
                String name = com.vater.clean.filemanager.Util.getNameFromFilepath(path);
