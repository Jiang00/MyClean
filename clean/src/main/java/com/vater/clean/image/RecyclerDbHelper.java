...
//        db.endTransaction();
    ...
    private String getRecyclerDirectory(String recyclerTime) {
        return Environment.getExternalStorageDirectory() + "/vaterbackup/" + recyclerTime + "/";
    }
    ...
    private void deleteOverDateRecyclerFile() {
        File file = new File(Environment.getExternalStorageDirectory() + "/vaterbackup");
