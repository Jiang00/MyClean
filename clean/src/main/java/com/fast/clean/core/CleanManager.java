...
import com.fast.clean.callback.AppCacheCallBack;
import com.fast.clean.callback.AppRamCallBack;
import com.fast.clean.callback.FileInfoCallBack;
import com.fast.clean.callback.SystemCacheCallBack;
import com.fast.clean.callback.UninstallResidualCallback;
import com.fast.clean.entity.JunkInfo;
import com.fast.clean.entity.Sizesort;
...
public class CleanManager {
        ...
        if (listInfo != null) {
            for (AndroidAppProcess info : listInfo) {
                ...
                try {
                    ...
                    if (!com.fast.clean.mutil.Util.isThirdApp(otherInfo) || packageName.equals(mContext.getPackageName()) || packageName.contains("com.acht")) {
                        continue;
                    }
    ...
    public void loadUninstallResidual(UninstallResidualCallback uninstallResidualCallback) {
        String data = com.fast.clean.mutil.Util.readFileFromAssets(mContext, "/raw/");
        uninstallSize = 0;
        ...
        if (!TextUtils.isEmpty(data)) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    long size = com.fast.clean.mutil.Util.getFileSize(file);
    ...
    public void loadSystemCache(final SystemCacheCallBack systemCacheCallBack) {
        ...
        for (int i = 0; i < packages.size(); i++) {
            ...
            if (!com.fast.clean.mutil.Util.isThirdApp(packageInfo.applicationInfo) || TextUtils.equals(packageInfo.packageName, mContext.getPackageName())) {
