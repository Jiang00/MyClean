package com.cleaner.similarimage;
...
//        db.endTransaction();
    ...
    private String getRecyclerDirectory(String recyclerTime) {
        return Environment.getExternalStorageDirectory() + "/bruderbackup/" + recyclerTime + "/";
    }
    ...
    private void deleteOverDateRecyclerFile() {
        File file = new File(Environment.getExternalStorageDirectory() + "/bruderbackup");
