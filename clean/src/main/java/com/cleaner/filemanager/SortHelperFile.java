...
public class SortHelperFile {
    ...
    private abstract class FileComparator implements Comparator<InfoFile> {

        @Override
        public int compare(InfoFile object1, InfoFile object2) {
        ...
        protected abstract int doCompare(InfoFile object1, InfoFile object2);
    }

    private Comparator cmpName = new FileComparator() {
        @Override
        public int doCompare(InfoFile object1, InfoFile object2) {
