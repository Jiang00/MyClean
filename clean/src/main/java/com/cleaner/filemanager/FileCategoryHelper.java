...
public class FileCategoryHelper {
    ...
    public HashMap<FileCategory, NameExtFilterFile> filters = new HashMap<>();
...
//                selection = "(" + FileColumns.MIME_TYPE + " == '" + Util.sZipFileMimeType + "')";
    ...
    private static String buildSortOrder(SortHelperFile.SortMethod sort) {
    ...
    public Cursor query(FileCategory fc, SortHelperFile.SortMethod sort) {
    ...
    public void refreshCategory() {
        ...
        Cursor cursor = query(FileCategoryHelper.FileCategory.Music, SortHelperFile.SortMethod.size);
