...
public class NotificationsMonitorService extends NotificationListenerService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            ...
            if (sbns == null || sbns.length == 0 || DataPre.getDB(this, KEY_NOTIFI, true)) {
    ...
    private void analysisSbn(StatusBarNotification sbn) {
        if (!DataPre.getDB(this, KEY_NOTIFI, true) || !sbn.isClearable()) {
            return;
        }
