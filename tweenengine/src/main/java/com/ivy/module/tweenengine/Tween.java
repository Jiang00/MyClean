...
public final class Tween extends BaseTween<Tween> {
	...
	private static int combinedAttrsLimit = 5;
	 ...
	 * <i>com.ivy.module.tweenengine.equations</i> package, but you can of course
	 ...
	 * @param targetValue2 The 2nd target value of the interpolation.
	 * @param targetValue3 The 3rd target value of the interpolation.
	 * @param targetValue4 The 4th target value of the interpolation.
	 * @return The current tween, for chaining instructions.
	 */
	public Tween target(float targetValue1, float targetValue2, float targetValue3, float targetValue4) {
		targetValues[0] = targetValue1;
		targetValues[1] = targetValue2;
		targetValues[2] = targetValue3;
	 ...
	 * @param targetValue2 The 2nd target value of the interpolation.
	 * @param targetValue3 The 3rd target value of the interpolation.
	 * @param targetValue4 The 3th target value of the interpolation.
	 * @param targetValue5 The 5th target value of the interpolation.
	 * @return The current tween, for chaining instructions.
	 */
	public Tween target(float targetValue1, float targetValue2, float targetValue3, float targetValue4, float targetValue5) {
		targetValues[0] = targetValue1;
		targetValues[1] = targetValue2;
		targetValues[2] = targetValue3;
		targetValues[3] = targetValue4;
		targetValues[4] = targetValue5;
		return this;
	}
