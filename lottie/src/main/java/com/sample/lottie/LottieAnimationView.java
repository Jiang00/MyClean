...
public class LottieAnimationView extends AppCompatImageView {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (!isInEditMode() && fileName != null) {
            setAnimation(themeContext, fileName);
        }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (!TextUtils.isEmpty(animationName)) {
            setAnimation(themeContext, animationName);
        }
    ...
    //使用第三方assets下的资源时 "theme://" + animationName
    ...
    //使用第三方应用的assets下的资源时 "theme://" + imageAssetsFolder
    // 使用SDCard内的图片资源时 "sdCard://" + imageAssetsFolder
    @SuppressWarnings("WeakerAccess")
    public void setImageAssetsFolder(Context themeContext, String imageAssetsFolder) {
    ...
    private static class SavedState extends View.BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR =
                new Creator<SavedState>() {
                    public LottieAnimationView.SavedState createFromParcel(Parcel in) {
                        return new LottieAnimationView.SavedState(in);
                    }

                    public LottieAnimationView.SavedState[] newArray(int size) {
                        return new LottieAnimationView.SavedState[size];
                    }
                };
    }
}